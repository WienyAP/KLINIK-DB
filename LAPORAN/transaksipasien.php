...
<body style="background-color: #d5f1eb;">
  ...
  <div class="container text-center">
    <div class="mt-5 mx-auto p-2 border badge text-center text-white" style="background-color: #569087; width: 100%;"><h4> TRANSAKSI PEMBELIAAN OBAT</h4></div>
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="row g-2 align-items-center text-center" style="width: 100%;">
            ...
            <div class="col order-last p-3">
                <input type="text" class="form-control" name="no_transaksi" id="no_transaksi" readonly>
            </div>
        </div>
        ...
        <div>
          <button type="submit" class="border badge" style="background-color: #153462; font-size: 20px;" name="submit" id="submit" >Tambah Data
          </button>
        </div>
