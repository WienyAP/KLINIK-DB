...
<body style="background-color: #d5f1eb;">
  ...
  <div class="container text-center">
    <div class="mt-5 mx-auto p-2 border badge text-center text-white" style="background-color: #569087; width: 100%;"><h4> TAMBAH DATA OBAT</h4></div>
    
    <form method="post">

        <div class="row g-2 align-items-center text-center" style="width: 100%;">
            <div class="col-2">
                <label for="nomor" class="col-form-label">No.</label>
            </div>
        ...
        <div class="row g-2 align-items-center text-center" style="width: 100%;">
            ...
            <div class="col order-last p-3">
                <input type="text" class="form-control" name="stok_obat" id="stok_obat" required>
            </div>
        </div>
