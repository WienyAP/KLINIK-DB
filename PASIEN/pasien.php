...
<body style="background-color: #d5f1eb;">
  ...
  <!--PASIEN-->
  <a class="border badge text-wrap p-2" href="tambah.php" style="background-color: #425f57; margin-left:80%; margin-top: 2rem;">Tambah Data Pasien</a>
    <div class="container text-center">
      <div class="col order-5 mt-1 mx-auto p-2 border badge text-wrap" style="background-color: #7eb8ac; width: 500px;"><h3> DATA PASIEN</h3></div> 
      <br><br>
    ...
    <br><br>
        <table class="table table-bordered" cellpadding="10" cellspacing="0" style="margin-top: -4rem;">
            ...
            <tr style="background-color: #7eb8ac; color:white;">
                ...
                <td>
                    <a href="update.php?id_pasien=<?= $row["id_pasien"];?>" class="btn btn-primary">Ubah</a>
                    <a href="hapus.php?id_pasien=<?php echo $row["id_pasien"];?>" onclick="return confirm('Yakin?')" class="btn btn-danger" >Hapus</a>
                </td>
            </tr>
            <?php $i++ ?>
            <?php endforeach;?>
        ...
        <?php
            ...
            $hitungjumlah = mysqli_fetch_array(mysqli_query($conn, "SELECT count(id_pasien) FROM pasien"))[0];
            ?>
