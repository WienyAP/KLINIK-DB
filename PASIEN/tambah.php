...
<body style="background-color: #d5f1eb;">
  ...
  <div class="container text-center">
    <div class="mt-5 mx-auto p-2 border badge text-center text-white" style="background-color: #569087; width: 100%;"><h4> TAMBAH DATA PASIEN</h4></div>
    ...
    <form method="post">
        ...
        <div class="row g-2 align-items-center text-center" style="width: 100%;">
            ...
            <div class="col order-last p-3">
                <input type="text" class="form-control" name="id_pasien" id="id_pasien" required value="<?php echo kode();?>">
            </div>
        </div>

        <div class="row g-2 align-items-center text-center" style="width: 100%;">
            <div class="col-2">
                <label for="nama_pasien" class="col-form-label">Nama</label>
            </div>
            <div class="col order-last p-3">
        ...
        <div class="row g-2 align-items-center text-center" style="width: 100%;">
            ...
            <div class="col order-last p-3">
                <input type="text" class="form-control" name="alamat_pasien" id="alamat_pasien" required>
            </div>
        </div>
        ...
        <div class="row g-2 align-items-center text-center" style="width: 100%;">
            ...
            <div class="col order-last p-3">
                <input type="text" class="form-control" name="telepon_pasien" id="telepon_pasien" required>
            </div>
        </div>
