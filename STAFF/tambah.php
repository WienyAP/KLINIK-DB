...
<body style="background-color: #d5f1eb;">
  ...
  <div class="container text-center">
    <div class="mt-5 mx-auto p-2 border badge text-center text-white" style="background-color: #569087; width: 100%;"><h4> TAMBAH DATA STAFF</h4></div>
    ...
    <form method="post">
        ...
        <div class="row g-2 align-items-center text-center" style="width: 100%;">
            ...
            <div class="col order-last p-3">
                <input type="text" class="form-control" name="jabatan_staff" id="jabatan_staff" required>
            </div>
        </div>
        ...
        <div class="row g-2 align-items-center text-center" style="width: 100%;">
            ...
            <div class="col order-last p-3">
                <input type="text" class="form-control" name="telepon_staff" id="telepon_staff" required>
            </div>
        </div>
