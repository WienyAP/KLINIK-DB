...
<body style="background-color: #d5f1eb;">
  ...
  <div class="container text-center">
    <div class="mt-5 mx-auto p-2 border badge text-center text-white" style="background-color: #569087; width: 100%;"><h4> TAMBAH DATA SUPLIER</h4></div>
    ...
    <form method="post">
        <div class="row g-2 align-items-center text-center" style="width: 100%;">
            ...
            <div class="col order-last p-3">
                <input type="text" class="form-control" name="no" id="no" disabled>
            </div>
        </div>
        ...
        <div class="row g-2 align-items-center text-center" style="width: 100%;">
            ...
            <div class="col order-last p-3">
                <input type="text" class="form-control" name="id_suplier" id="id_suplier" required>
            </div>
        </div>
        ...
        <div class="row g-2 align-items-center text-center" style="width: 100%;">
            ...
            <div class="col order-last p-3">
                <input type="text" class="form-control" name="nama_suplier" id="nama_suplier" required>
            </div>
        </div>
        ...
        <div class="row g-2 align-items-center text-center" style="width: 100%;">
            ...
            <div class="col order-last p-3">
                <input type="text" class="form-control" name="alamat_suplier" id="alamat_suplier" required>
            </div>
        </div>
        ...
        <div class="row g-2 align-items-center text-center" style="width: 100%;">
            ...
            <div class="col order-last p-3">
                <input type="text" class="form-control" name="telepon_suplier" id="telepon_suplier" required>
            </div>
        </div>

        <div>
            <button type="submit" class="border badge" style="background-color: #153462; font-size: 20px;" name="submit" id="submit">Tambah Data</button>   
        </div>
